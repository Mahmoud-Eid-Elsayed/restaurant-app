...
<body>
    <div class="container-fluid form-container">
        <div class="avatar-container">
            <img src="../../../assets/images/login&register/chef-cash-register_18591-35958.avif" width="80%"
                alt="Avatar">
        </div>
        <div class="form-wrapper me-5 bg-light">
            <form method="post" action="../../php/user/signupHandle.php" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" name="phonenumber" placeholder="Phone Number"
                                value="<?= htmlspecialchars($formData['phonenumber'] ?? '') ?>" required>
                ...
                <div class="form-group form-check my-3">
                    <input type="checkbox" class="form-check-input" id="cond-term" required>
                    <label class="form-check-label" for="cond-term">Agree to terms and conditions</label>
                </div>
