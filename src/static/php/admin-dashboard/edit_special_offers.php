...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $imageURL = $offer['ImageURL']; // Keep the existing image URL by default
                ...
                <div class="main-content">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="description" name="description" value="<?php echo $offer['Description']; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="discountPercentage" class="form-label">Discount Percentage</label>
                            <input type="number" step="0.01" class="form-control" id="discountPercentage" name="discountPercentage" value="<?php echo $offer['DiscountPercentage']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="discountAmount" class="form-label">Discount Amount</label>
                            <input type="number" step="0.01" class="form-control" id="discountAmount" name="discountAmount" value="<?php echo $offer['DiscountAmount']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="startDate" class="form-label">Start Date</label>
                            <input type="datetime-local" class="form-control" id="startDate" name="startDate" value="<?php echo date('Y-m-d\TH:i', strtotime($offer['StartDate'])); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="expiryDate" class="form-label">Expiry Date</label>
                            <input type="datetime-local" class="form-control" id="expiryDate" name="expiryDate" value="<?php echo date('Y-m-d\TH:i', strtotime($offer['ExpiryDate'])); ?>" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="offerCode" name="offerCode" value="<?php echo $offer['OfferCode']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="image" class="form-label">Image</label>
                            <input type="file" class="form-control" id="image" name="image" accept="image/*">
                            <?php if ($offer['ImageURL']): ?>
                                <p>Current Image: <img src="<?php echo $offer['ImageURL']; ?>" alt="Current Image" style="max-width: 200px;"></p>
                            <?php endif; ?>
                        </div>
